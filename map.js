...
function initMap() {
  ...
  autocomplete.addListener("place_changed", () => {
    ...
    deleteButton.setAttribute(
      "style",
      "border-radius: 70%; height: 30px; width: 30px; color: #FFFFFF; background-color: #FF0000;\
    ...
    waypointAddress.appendChild(
      document.createTextNode("Full Address: " + waypoint.name)
    );
    waypointLat.appendChild(
      document.createTextNode("Latitude: " + waypoint.lat)
    );
    waypointLon.appendChild(
      document.createTextNode("Longtitude: " + waypoint.lon)
    );
